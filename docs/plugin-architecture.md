...
| 4 | `EtherCATWorkbenchPlugin` | In progress | Editable pages, CoE Online Mock, and the visible process-data tree are complete; remaining UI qualification is open |
